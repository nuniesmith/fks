...
the most commonly used symbols so callers can write::
    ...
    from trading.strategies.rb import (
        BreakoutType,
        RangeConfig,
        get_range_config,
...
# ---------------------------------------------------------------------------
from core.breakout_types import (
    BreakoutType,
    RangeConfig,
    all_range_configs,
...
# ---------------------------------------------------------------------------
from services.engine.handlers import (
    fetch_bars_1m,
...
# ---------------------------------------------------------------------------
from trading.strategies.rb.breakout import (
    DEFAULT_CONFIGS,
)
...
# ---------------------------------------------------------------------------
from trading.strategies.rb.detector import (
    BreakoutResult,
    detect_all_breakout_types,
    detect_breakout_for_type,
...
# ---------------------------------------------------------------------------
from trading.strategies.rb.publisher import (
...
# ---------------------------------------------------------------------------
from trading.strategies.rb.range_builders import (
    build_asian_range,

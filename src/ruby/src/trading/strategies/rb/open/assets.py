...
if TYPE_CHECKING:
    from trading.strategies.rb.open.sessions import ORBSession
...
try:
    from core.models import ENABLE_KRAKEN_CRYPTO as _ENABLE_KRAKEN_CRYPTO

    if _ENABLE_KRAKEN_CRYPTO:
        from integrations.kraken_client import KRAKEN_PAIRS as _KRAKEN_PAIRS

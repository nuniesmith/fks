...
@shared_task(bind=True, name='trading_app.tasks.fetch_latest_prices')
...
@shared_task(bind=True, name='trading_app.tasks.fetch_historical_data')
...
@shared_task(bind=True, name='trading_app.tasks.generate_trading_signals')
...
@shared_task(bind=True, name='trading_app.tasks.update_open_positions')
...
@shared_task(bind=True, name='trading_app.tasks.check_position_triggers')
...
@shared_task(bind=True, name='trading_app.tasks.record_account_balances')
...
@shared_task(bind=True, name='trading_app.tasks.run_daily_optimization')
...
@shared_task(bind=True, name='trading_app.tasks.send_discord_notification')
...
@shared_task(bind=True, name='trading_app.tasks.send_performance_summary')
...
@shared_task(bind=True, name='trading_app.tasks.cleanup_old_data')
...
@shared_task(bind=True, name='trading_app.tasks.run_backtest_async')
...
@shared_task(bind=True, name='trading_app.tasks.ingest_completed_trades')
...
@shared_task(bind=True, name='trading_app.tasks.ingest_trading_signals')
...
@shared_task(bind=True, name='trading_app.tasks.ingest_backtest_results')
...
@shared_task(bind=True, name='trading_app.tasks.ingest_all_trading_data')
...
@shared_task(bind=True, name='trading_app.tasks.cleanup_old_rag_data')

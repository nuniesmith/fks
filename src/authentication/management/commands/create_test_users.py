...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if created:
            ...
            admin.save()
            self.stdout.write(self.style.SUCCESS(f'✓ Created admin: {admin.username} / admin123'))
        else:
        ...
        if created:
            ...
            trader.save()
            self.stdout.write(self.style.SUCCESS(f'✓ Created trader: {trader.username} / trader123'))
            ...
            self.stdout.write(self.style.WARNING(f'⚠ Trader user already exists: {trader.username}'))
        ...
        if created:
            ...
            analyst.save()
            self.stdout.write(self.style.SUCCESS(f'✓ Created analyst: {analyst.username} / analyst123'))
        else:
            self.stdout.write(self.style.WARNING(f'⚠ Analyst user already exists: {analyst.username}'))
        ...
        if created:
            ...
            trial.save()
            self.stdout.write(self.style.SUCCESS(f'✓ Created trial: {trial.username} / trial123'))
        else:
            self.stdout.write(self.style.WARNING(f'⚠ Trial user already exists: {trial.username}'))
        ...
        if created:
            ...
            viewer.save()
            self.stdout.write(self.style.SUCCESS(f'✓ Created viewer: {viewer.username} / viewer123'))
        else:
            self.stdout.write(self.style.WARNING(f'⚠ Viewer user already exists: {viewer.username}'))

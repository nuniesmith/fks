...
class BacktestView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['backtest_result'] = {
            ...
            'duration': '90 days',
            'trades': [
                {'date': '2024-01-15', 'type': 'LONG', 'type_color': 'success', 
                 'entry': 42000, 'exit': 42500, 'pnl': 500, 'pnl_percent': 1.19, 'duration': '4h'},
                {'date': '2024-01-16', 'type': 'SHORT', 'type_color': 'danger',
                 'entry': 42800, 'exit': 42300, 'pnl': 500, 'pnl_percent': 1.17, 'duration': '6h'},
            ]
        }

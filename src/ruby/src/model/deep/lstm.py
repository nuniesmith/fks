...
from model._shims import log_execution, logger
...
_LSTMNetworkBase = nn.Module if (HAS_TORCH and nn is not None) else object


class LSTMNetwork(_LSTMNetworkBase):  # type: ignore[misc,valid-type]
    """
...
_LightningBase = pl.LightningModule if HAS_LIGHTNING else object


class LightningLSTMModel(_LightningBase):  # type: ignore[misc,valid-type]
    """

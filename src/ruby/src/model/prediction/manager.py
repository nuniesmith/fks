...
if TYPE_CHECKING:
    from model.ml.gaussian import GaussianModel as GaussianPredictor
    from model.ml.polynomial import PolynomialRegression as PolynomialPredictor
    from model.statistical.bayesian import BayesianLinearRegression as BayesianPredictor
else:
    try:
        from model.statistical.bayesian import BayesianLinearRegression as BayesianPredictor
    except ImportError:

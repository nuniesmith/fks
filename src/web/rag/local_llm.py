...
class LocalLLM:
    ...
    def _init_llamacpp(self):
        ...
        try:
            ...
            model_path = os.getenv('LLAMA_MODEL_PATH', f'./models/{self.model_name}.gguf')
    ...
    def _generate_transformers(self, prompt: str, system_prompt: Optional[str], **kwargs) -> str:
    ...
    def _generate_llamacpp(self, prompt: str, system_prompt: Optional[str], **kwargs) -> str:
...
def create_local_llm(model_name: str = "llama3.2:3b",
                    backend: str = "ollama") -> LocalLLM:
    """

...
///
/// ```
/// use sevcik::SevcikFractalDimension;
///
...
impl SevcikFractalDimension {
    ...
    fn calculate_dimension(&self) -> Result<FractalResult, FractalError> {
        ...
        // TODO: Consider SIMD optimization here (AVX-512)
        let y_norm: Vec<f64> = self.buffer
            .iter()
...
mod tests {
    ...
    fn test_sevcik_trending() {
        ...
        assert!(result.dimension < 1.5, "Expected D < 1.5, got {}", result.dimension);

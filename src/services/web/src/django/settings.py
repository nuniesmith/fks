...
INSTALLED_APPS = [
    ...
    # Local apps - FKS Main orchestrator apps from src/
    "authentication",  # ✅ Authentication system
    "core",  # ✅ Core models and database
    "monitor",  # ✅ Service monitoring and health checks
    # "framework",  # Framework middleware and utilities (no models)
    # "config",  # Configuration (no models)
    # Web service app from src/services/web/src/
    "services.web.src",  # ✅ Web UI, templates, views
]
...
ROOT_URLCONF = "services.web.src.django.urls"
...
WSGI_APPLICATION = "services.web.src.django.wsgi.application"

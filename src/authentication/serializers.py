...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            'user_type', 'status', 'api_key_enabled', 'timezone',
...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserProfile
        fields = (
            'user', 'risk_tolerance', 'default_strategy', 'preferred_exchanges',
            'email_notifications', 'discord_notifications', 'total_trades',
            'successful_trades', 'success_rate'
        )
...
class UserSessionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserSession
        fields = ('id', 'session_key', 'device_type', 'ip_address', 'country', 
                  'city', 'created_at', 'last_activity', 'is_active')

"""
analysis.sentiment — Sentiment analysis sub-package.

Re-exports the public API from both sentiment modules so callers can use either:

    from analysis.sentiment import NewsSentiment, compute_news_sentiment
    from analysis.sentiment.news_sentiment import compute_news_sentiment
    from analysis.sentiment.reddit_sentiment import get_full_snapshot
"""

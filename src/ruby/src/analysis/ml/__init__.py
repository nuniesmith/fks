"""
analysis.ml — Machine learning sub-package.

Re-exports the public API from the breakout CNN module so callers can use either:

    from analysis.ml import HybridBreakoutCNN, predict_breakout
    from analysis.ml.breakout_cnn import HybridBreakoutCNN, predict_breakout
"""

...
try:
    from core.factory import ServiceFactory, create_fastapi_service, create_flask_service, run_service
    from core.fastapi import FastApiService
...
from core.initialization import initialize, load_configuration
from core.lifespan import get_app_lifecycle

# Direct use of the comprehensive logging system
from core.logging_config import get_logger, setup_logging
from core.teardown import emergency_shutdown, teardown

...
#        - IndicatorManager  → lib/indicators/presets.py
#        - technical_indicators → lib/indicators/manager.py
#
...
__all__ = [
    # Manager (used by presets.py internally via `from indicators import IndicatorManager`)
    "IndicatorManager",
    ...
    "SchaffTrendCycle",
    "WilliamsRIndicator",
    # Catalog lists (used by manager.py internally via `from indicators import technical_indicators`)

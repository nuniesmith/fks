...
existing callers only need to update their import path::
    ...
    # old
    from trading.strategies.rb.orb import LONDON_SESSION, detect_opening_range_breakout

    # new
    from trading.strategies.rb.open import LONDON_SESSION, detect_opening_range_breakout
"""
...
# ---------------------------------------------------------------------------
from trading.strategies.rb.open.assets import (
...
# ---------------------------------------------------------------------------
from trading.strategies.rb.open.detector import (
    compute_atr,
...
# ---------------------------------------------------------------------------
from trading.strategies.rb.open.models import (
...
# Publisher — Redis I/O
# ---------------------------------------------------------------------------
from trading.strategies.rb.open.publisher import (
    REDIS_KEY_ORB,
    REDIS_KEY_ORB_TS,
    REDIS_PUBSUB_ORB,
    REDIS_TTL,
...
# ---------------------------------------------------------------------------
from trading.strategies.rb.open.sessions import (
    ATR_PERIOD,

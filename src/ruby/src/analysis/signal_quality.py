...
def _detect_bullish_candle(
    ...
    # Hammer pattern
    hammer = (
        body_size < candle_range * 0.3 and lower_wick > body_size * 2 and upper_wick < body_size
    )
...
def _detect_bearish_candle(
    ...
    # Shooting star
    shooting_star = (
        body_size < candle_range * 0.3 and upper_wick > body_size * 2 and lower_wick < body_size
    )

...
class DocumentProcessor:
    ...
    def chunk_market_report(self, report_text: str, symbol: str, timeframe: str) -> List[Chunk]:
        """
...
def create_processor(chunk_size: int = 512, chunk_overlap: int = 50) -> DocumentProcessor:

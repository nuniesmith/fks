...
from core.breakout_types import BreakoutType, RangeConfig, get_range_config
...
# Re-export so existing ``from trading.strategies.rb.breakout import BreakoutType``
...
def breakout_type_from_short_name(name: str) -> BreakoutType:
    ...
    from core.breakout_types import breakout_type_from_name

...
Design decisions:
  ...
  - Initial centroids placed at lowvol/midvol/highvol percentiles of the ATR range
...
def _compute_percentile(
    ...
    Loop-based percentile calculation:
...
def kmeans_volatility_clusters(
    ...
    Complete volatility clustering:

...
functions imported from analysis.volume_profile.
"""
...
from analysis.volume_profile import _rolling_poc, _rolling_vah_val
from core.logging_config import get_logger
from core.utils import atr as _atr
from core.utils import ema as _ema
from core.utils import rsi as _rsi
...
def _compute_ict_confluence(
    ...
    try:
        from analysis.ict import get_active_order_blocks, get_unfilled_fvgs
    except ImportError:
        return result
    ...
    from analysis.ict import _atr as ict_atr

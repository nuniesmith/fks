...
**CI/CD (7-image matrix — `nuniesmith/fks`):**
...
Engine fires CNN-gated signal
  ...
  │    → signals.csv committed to nuniesmith/fks-signals (GitHub API)
  ...
  │    → Ruby indicator shows levels on chart for visual confirmation
